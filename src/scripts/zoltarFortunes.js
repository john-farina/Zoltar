export const zoltarFortunes = [
    `You've been wondering what to do
  ...
  shabby hat.`,
    ...
    `If you subdue yourself and return to
   ...
   son at his best.`,
    ...
    `You may be riding the winds of
    ...
    `Now is the time to start that new
    ...
    `You've been wondering if you have
    ...
    dissolve the beauty of thy brow.`,

    `You emerge from your recent fog
    ...
    basics of life to master indeed.`,

    `I see a great deal of happiness in
